...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { classroom_name: @classroom.classroom_name, classroom_total: @classroom.classroom_total }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { classroom_name: @classroom.classroom_name, classroom_total: @classroom.classroom_total }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
